...
// Комментарий по решению: в условии не сказано,
// должен ли быть массив задан случайными числами.
// Поэтому в решении массив последовательно заполняется от 10 до 99.
// Заполнить неповторяющимися числами с использованием рандома у меня
// не получилось.
